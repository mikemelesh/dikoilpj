...
| `manager` | Управление заказами, клиентами, услугами, акциями |
| `technician` | Просмотр назначенных заказов, запросы материалов |
| `client` | Создание заказов, просмотр своих заказов |
